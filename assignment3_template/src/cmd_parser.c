...
static void _cmd_fd_pressure1(int, char *[]);
static void _cmd_fd_temperature1(int, char *[]);
static void _cmd_fd_temperature2(int, char *[]);
static void _cmd_fd_temperature3(int, char *[]);
...
static void _cmd_com_start(int, char *[]);
static void _cmd_com_stop(int, char *[]);
...
static CMD_T cmd_table[] =
{
    ...
    {_cmd_fd_pressure1,     "fd_set_pressure1", "[%f]",         "Sets pressure 1 value entering the fault detection module by calling module_fault_detect_manual_pressure1()."},
    {_cmd_fd_temperature1,  "fd_set_temp1",     "[%f]",         "Sets temperature 1 value entering the fault detection module by calling module_fault_detect_manual_temperature1()"},
    {_cmd_fd_temperature2,  "fd_set_temp2",     "[%f]",         "Sets temperature 2 value entering the fault detection module by calling module_fault_detect_manual_temperature2()"},
    {_cmd_fd_temperature3,  "fd_set_temp3",     "[%f]",         "Sets temperature 3 value entering the fault detection module by calling module_fault_detect_manual_temperature3()"},
    {_cmd_fd_estop,         "fd_set_estop",     "[%i]",         "Sets estop state entering the fault detection module by calling module_fault_detect_manual_estop(). 0=healthy, 1=fault."},
    {_cmd_fd_error,         "fd_set_error",     "[%i]",         "Sets error state entering the fault detection module by calling module_fault_detect_manual_error()."},
    ...
    {_cmd_sm_error,         "sm_set_error",     "[%i]",         "Sets the error state entering the state machine by calling module_state_machine_manual_error()."},
    ...
    {_cmd_opt_state,        "opt_set_state",    "[%i]",         "Sets the state of the output module by calling module_outputs_manual_state(). 0=healthy, 1=fault."},
    {_cmd_com_start,        "com_start",        "",             "Starts the comms module thread by calling module_comms_start()."},
    {_cmd_com_stop,         "com_stop",         "",             "Stops the comms module thread by calling module_comms_stop()."},
};
...
void _cmd_fd_pressure1(int argc, char *argv[])
{
    if (argc == 2)
    {
        // Set pressure value
        module_fault_detect_manual_pressure1(atof(argv[1]));
    }
    else
    {
        printf("Incorrect number of inputs\n");
...
void _cmd_fd_temperature1(int argc, char *argv[])
{
    if (argc == 2)
    {
        // Set temperature value
        module_fault_detect_manual_temperature1(atof(argv[1]));
    }
    else
    {
        printf("Incorrect number of inputs\n");
...
void _cmd_fd_temperature2(int argc, char *argv[])
{
    if (argc == 2)
    {
        // Set temperature value
        module_fault_detect_manual_temperature2(atof(argv[1]));
    }
    else
    {
        printf("Incorrect number of inputs\n");
...
void _cmd_fd_temperature3(int argc, char *argv[])
{
    if (argc == 2)
    {
        // Set temperature value
        module_fault_detect_manual_temperature3(atof(argv[1]));
    }
    else
    {
        printf("Incorrect number of inputs\n");
...
void _cmd_com_start(int argc, char *argv[])
{
    UNUSED(argc);
    UNUSED(argv);
...
void _cmd_com_stop(int argc, char *argv[])
{
    UNUSED(argc);
    UNUSED(argv);
